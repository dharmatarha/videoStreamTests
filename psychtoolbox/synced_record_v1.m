function synced_record_v1(pairNo, labName)

%% UDP handshake + video-audio capture and playback.
%
% USAGE: synced_record_v1(pairNo, labName)
%
...
%
% Inputs:
% pairNo    - Numeric value, one of 1:99. Pair number.
% labName   - Char array, one of {"Mordor", "Gondor"}
%
% Outputs are saved out into
%
%
%
